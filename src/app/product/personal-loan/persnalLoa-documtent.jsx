...
import { UserCheck, MapPin, Banknote, Briefcase, Calculator, FileCheck } from 'lucide-react';
...
const DocumentsRequired = () => {
    ...
    // Document Data (Updated for Personal Loan as per request)
    const documents = [
        {
            ...
            <div className="container mx-auto px-4 md:px-12">
                ...
                >
                    ...
                    <p className="text-base md:text-lg text-[#6D3078]/80 max-w-3xl leading-relaxed mx-auto md:mx-0">
                        Maitrii Loan has simplified the process of securing a Personal Loan. Please provide a self-attested copy of relevant documents from each category listed below.
                    </p>
                </motion.div>
