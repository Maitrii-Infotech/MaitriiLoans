            ...
            <div className="container mx-auto px-6 md:px-12 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                >
                    ...
                    <p className="text-lg text-[#6D3078] leading-relaxed font-medium">
                        Expand your horizons with our Business Loans. Whether for equipment, inventory, or expansion, we fuel your growth journey.
                    </p>
                    <div className="mt-6">
                ...
                {/* --- Right Side: Custom SVG for Business Loan --- */}
                <motion.div
