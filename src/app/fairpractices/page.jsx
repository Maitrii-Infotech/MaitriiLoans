        ...
        <div className="w-full bg-[#F8FAFC] min-h-screen font-sans text-slate-700">
            ...
            <div className="container mx-auto px-6 md:px-12 py-12 max-w-5xl">
                ...
                <section className="mb-10">
                    ...
                    <ul className="list-disc list-outside ml-5 space-y-3 text-slate-600 text-justify">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        ...
                        <ul className="list-disc list-outside ml-4 space-y-2 text-sm text-slate-600 text-justify">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        ...
                        <p className="text-sm leading-relaxed text-slate-600 text-justify mb-2">When an individual is considered an underwriter to a loan, the company will inform him/her the following under confirmation:</p>
                        <ul className="list-disc list-outside ml-4 space-y-2 text-sm text-slate-600 text-justify">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                        ...
                        <p className="text-sm leading-relaxed text-slate-600 text-justify mb-2">The Company may offer information to Credit Bureau/Reference offices about the individual obligations, the client owes to it if:</p>
                        <ul className="list-disc list-outside ml-4 space-y-2 text-sm text-slate-600 text-justify">
